  ...
  useEffect(() => {
    if (user) {
      setProfileData({
        ...
        experience_years: user.trainerProfile?.experience_years?.toString() || '',
        certifications: Array.isArray(user.trainerProfile?.certifications) 
          ? user.trainerProfile.certifications.join(', ') 
